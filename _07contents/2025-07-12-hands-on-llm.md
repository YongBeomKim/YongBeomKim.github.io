...
# 마무리
세부 파트들의 작동에 대하여 **<span style="color:orange">부분의 설명에 대한 이미지들이 숫자가 많고 내용이 상세하다 보니 자칫 `해당 페이지에서 설명하는 내용` 이 전체적인 내용 중 어느 부분에 해당하는지가 애매해 질 수 있어서</span>** 이 부분이 조금은 아쉬웠습니다.

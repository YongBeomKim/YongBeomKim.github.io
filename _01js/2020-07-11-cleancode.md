...
webpack 의 **css-loader, styled-components** 2개를 활용하여 CSS Modules 을 구현 가능합니다.**클린코드, 리팩토링, Design Pattern** 의 내용을 잘 모르고 지내던 중, 스터디에서 **클린코드** 내용이 언급 되고 나서 도서 내용 직접 읽어보니 중요성을 알 수 있었습니다.
...
이들 중 **클린코드** 내용을 간단하게 살펴보겠습니다.



# clean-code-javascript

- [GitBook 한글판](https://kwosu87.gitbooks.io/clean-code/content/)
- [클린코드 JavaScript 한글판](https://github.com/qkraudghgh/clean-code-javascript-ko)

...
### 1-1 일반현황
- 김용범, 맛 지도 UI를 활용한 식단 추천 및 식자재 정보 시스템
- 정보통신 김용범

### 1-2 창업 아이템 개요 (요약)
일반 가정 및 중소식당을 위한 메뉴 및 식품정보 시스템
...
### 1-2 창업 아이템의 목적 (필요성)
공공데이터 개방정책과, 농산물 온라인 유통이 활발해 지고 있는 지금, 이를 개방적인 서비스와 간편한 UI를 활용하여 가정 및 중소식당을 위한 메뉴관리 서비스를 제공한다면, 다양한 식단을 구성하고 불필요한 식자재 구매를 줄일 수 있습니다. 또한 지역 내 다양한 농`산물 유통업체를 활용할 계기가 될 것입니다.
...
공개된 모범 메뉴별 레시피 정보를 활용하여 기본 모델을 구축한 뒤, 다양한 플랫폼에 공개된 메뉴와 레시피들의 의 출처를 공개하며 접근를 활용하여 다양한 플랫폼에서 제공되는 메뉴와 식품 정보를
 ...
 예산과 주의할 점 등의 정보를 종 측정 가능하고, 반대로 활용하여 **냉장고 파먹기** 키워드 등으로 공개된 재료별 다양한 레시피 목록을 
...
1차적으로는 공개데이터와 직접 사용하던 **재료요청서** 를 바탕으로 구성하고, 블로그 등으로 공개된 다양한 레시피를 협조요청 후 활용하는 방식

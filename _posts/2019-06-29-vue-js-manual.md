...
last_modified_at: 2019-06-29T12:45:06-05:00
header:
...
**HTML 기본 구조** 를 익힌 뒤 **CSS3** 를 활용한 다양한 효과들을 익혔습니다. 이를 바탕으로 **DOM 객체들을 조작하고 사용자 이벤트에 따라** 다양한 조작이 가능한 **JavaScrpt** 를 활용합니다. 

JavaScript 는 **개별 객체** 와 **함수들을** 선언해야 되는만큼 작업량이 많아지는 단점이 있습니다. 이를 쉽게 도와주는 모듈중 가장 오래된 것이 **Jquery** 입니다. 이를 바탕으로 작업 가능한 예제들을 익혀 보았습니다. **Vue.js** 와 **React** 등의 **PWA (A progressive Web application)** 를 활용하는 예제를 정리해 보겠습니다.

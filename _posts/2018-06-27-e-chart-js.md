...
<samll>**E chart** 옵션값 등에서 **중국어**를 사용하면 추가 기능이 가능하다. 서버 확인시 `echarts.min.js` 의 동작을 위해서 중국어를 설치하고 소스코드에서는 중국어 사용을 최소화 함으로써 활용을 발전시켜 나아가야 한다</samll>
...
<small>또는 [Down Page](https://ecomfe.github.io/echarts-doc/public/en/download.html)에서 다운 받아서 사용하면 된다.</small>
...
`stack : '总量'` 을 활성화 하면 **누적 합 값**을 출력한다 <small>중국놈들이 만들었다는 티를 여기저기 나게 만들었다 ㅜㅜ..</small>

...
결론만 언급하자면 당시에는 RestAPI의 모든걸 대체가능하리라 생각했지만, 복잡하고 다양한 작업에 적합하고, 데이터 호출 이외에 파일의 전송에 있어서는 RestAPI가 더 안정적이라는 등 [블로그](https://www.holaxprogramming.com/2018/01/20/graphql-vs-restful-api/) 상호 보완적인 역활을 하는 것을 알 수 잇었다.

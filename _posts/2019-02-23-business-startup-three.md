...
주간 메뉴 추천 및 이를 활용한 식당 창업 원가계산 및 수익률 예측
...
공공데이터의 개방으로 식자재 가격정보와 레시피 데이터는 많지만, 이들을 연결하는 메뉴관리 및 메뉴구성 추천 시스템을 제안한다면 어떠한 모습일까? 이러한 메뉴관리 시스템을 활용하여 남는 식자재를 활용한 메뉴추천 및 메뉴 식당 창업시 예상되는 원가분석 시뮬레이션등 다양한 부가서비스로 발전이 가능합니다

### 1-2 창업 아이템의 목적 (필요성)
날씨 변화에 따른 대중의 입만변화와 식자재 가격, 연령대별 선호도 가중치 그리고 뉴스 데이터 및 커뮤니티별 상위 검색어 등을 활용한 대중의 관심도 높은 메뉴조합을 추천하고, 헤닝의 4원미 (단맛, 신맛, 쓴맛, 짠맛) 을 활용한  간편한 UI로 사용자 접근성을 높일 수 있습니다

## 2 실현가능성
### 2-1 창업아이템의 개발 사업화 전략
때문에 빠른 기간내 시범운영을 진행하고(5월~8월), 이번 프로그램의 진행 기간동안 전문 외주업체를 활용하여 **알고리즘의 최적화 및 서비스의 구체화** 를 진행합니다

### 2-2 창업아이템의 시장분석 및 경쟁력 확보방안
공개된 식자재 가격정보 및 레시피 데이터등을 활용하여 기본 모델을 구성 및 보완을 하고, 실제 구내식당내 반응 데이터를 활용한 사용자별 선호도, 그리고 메뉴추천 서비스 이용자 분의 피드백을 활용한 신 메뉴의 추가 및 로그 데이터 분석 등 의 내용을 활용합니다

## 3 성장전략
### 3-1 자금소요 및 조달계획
- 2018. 8. 28. CJ제일제당이 '한식 세계화' 글로벌 사업을 위한 업체를 공격적으로 인수
- 관련 기업 한식진흥원 등의 기관 투자 진행
...
## 4 팀구성
- 대표자 : 김용범 
  - 딥러닝 활용 자연어 강사 (삼성전자 서울캠퍼스 2018) 
  - 금융분석, 챗봇 개발 및 컨설팅 (인공지능 아카데미 2018~2019)
- 팀원 : 김명진
  - 안양시 동안구 두산벤처다임 구내식당 총괄 매니저 (무영인터내쇼날 2007~2017) 
...
|   2  | 라임프랜즈 | 웹 서비스 개발/운영   | 어플개발 및 웹서비스 운용 |     |

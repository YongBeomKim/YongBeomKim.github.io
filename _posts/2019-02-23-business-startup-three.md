...
## 1 문제인식
### 1-1 창업 아이템의 개발동기
공공데이터의 개방으로 식자재 가격정보와 레시피 데이터는 많지만, 이들을 연결하는 메뉴관리 및 메뉴구성 추천 시스템을 제안한다면 어떠한 모습일까? 이러한 메뉴관리 시스템을 활용하여 남는 식자재를 활용한 메뉴추천 및 메뉴 식당 창업시 예상되는 원가분석 시물레이션등 다양한 부가서비스로 발전이 가능합니다

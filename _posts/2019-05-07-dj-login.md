...
header:
  overlay_image: /assets/images/code/webauth.png
categories:
  - django
tags: 
    - model
...
Django AllAuth 에서 **[Naver 설정방법](https://django-allauth.readthedocs.io/en/latest/providers.html?highlight=naver#naver)** 에 따라 웹서비스 등록 방법을 참조하여 등록 합니다.

...
와 같은 오류가 발생합니다. 특히 Django 2.2 에서 `django.contrib.sites` 추가 및 `SITE_ID = 1` 등의 내용입력을 꼼꼼히 진행 합니다 
...
[구글 개발자 콘솔](https://console.developers.google.com/) 에 로그인 한뒤 아래의 동영상에 따라 서비스를 등록 및 ClientID 와 Key 값을 생성 합니다.

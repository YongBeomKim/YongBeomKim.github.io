...
<small>[chart js CDN 주소들](https://cdnjs.com/libraries/Chart.js)</small>

```
https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.min.js
```

또는 [https://github.com/chartjs/Chart.js/releases](https://github.com/chartjs/Chart.js/releases) 에서 위의 Javascript 파일을 다운로드 하면 된다
{: .notice--info}

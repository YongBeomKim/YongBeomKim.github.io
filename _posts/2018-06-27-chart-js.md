...
**CodingEntrepreneurs** Django 초창기 부터 관심있게 봤었지만 이해를 하지 못해서 저장만 해 두고 있다가 이번에 시험해본 결과 가장 깔끔하고 다양한 반응형 결과를 제공하는 것을 볼 수 있었다. [github](https://github.com/codingforentrepreneurs/Django-Chart.js) | [project Web](https://www.codingforentrepreneurs.com/projects/) | [YouTube](https://www.youtube.com/channel/UCWEHue8kksIaktO8KTTN_zg)
{: .notice--info}
...
**script** 페이지별 각기 다른 jquery 내용을 추가하는데 있어서 반복을 줄이기 위해서 **jquery** 블록을 사용하는 응용방법을 보여줬다
{: .notice--info}
...
**CodingEntrepreneurs** [YouTube](https://www.youtube.com/channel/UCWEHue8kksIaktO8KTTN_zg) 에서 제작한 동영상으로 Django 초창기 부터 관심있게 봤었지만 이해를 하지 못해서 저장만 해 두고 있다가 이번에 Tutorial을 따라 해보다 보니 결과물이 깔끔하고 다양한 반응형 결과를 제공하는 것을 볼 수 있었다.

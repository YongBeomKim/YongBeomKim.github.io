...
**[^\]+ :** \를 제외한 1개 이상의 문자, **\d+ :** 1개 이상의 숫자,  **\d? :** 0개 또는 1개의 숫자, **\d{1,3} :** 숫자 1개 2개 또는 3개
{: .notice--primary}
...
**Debug:** 명시적인 변수연결로, 인수 순서 버그에 덜 취약하고, 인수를 재정렬 가능하다. 단점은 간결성 일부를 포기해야 한다는 점이다.
{: .notice--success}

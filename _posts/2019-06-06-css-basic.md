...
**[MIT 라이센스](https://github.com/daneden/animate.css)**  모듈로 업데이트가 아직까지도 활발하게 이루어 지고 있습니다. **[CDN경로](https://cdnjs.com/libraries/animate.css/)** 로써 `<link href="https://fonts.googleapis.com/css?family=Slabo+27px&display=swap" rel="stylesheet">` 를 활용하면 서버 부담이 줄어듭니다.

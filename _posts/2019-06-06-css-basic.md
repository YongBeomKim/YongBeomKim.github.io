...
**[반응형 웹 페이지](https://msdn.microsoft.com/ko-kr/library/bg124109)** 를 작업하기 위한 기본 개념과 설정 내용들을 익혀보도록 하겠습니다. CSS 스타일을 작업하면서 이해 안되는 부분을 정리 합니다

...
**[반응형 웹 페이지](https://msdn.microsoft.com/ko-kr/library/bg124109)** 를 작업하기 위한 기본 개념과 설정 내용들을 익혀보도록 하겠습니다. CSS 스타일을 작업하면서 이해 안되는 부분들 정리 합니다
...
**15vw :** 을 사용하는 경우 **윈도우 전체너비** 를 **100vm** 으로 기준 삼고서 상대크기를 자동으로 계산 합니다. **[w3school](https://www.w3schools.com/cssref/tryit.asp?filename=trycss_unit_em)** 사이트의 예제를 활용하여 간단한 실습을 하면 이해하기 더 용이 합니다.

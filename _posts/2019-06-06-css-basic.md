...
**flex-grow** 는 **0 ~ n** 의 값을 사용 가능하고 container 내부의 item 이 **container 의 내부영역의 여백** 을 **1/n 씩 채우는 비율의 정수값** 을 의미 합니다. **0** 인 경우 item 크기만큼만 사용 합니다

**flex-shrink** 는 **0 ~ n** 의 값을 사용 가능하고 container 내부 item 이 **Basis 값보다 줄어들 때 축소비율의 값** 을 의미 합니다.  **0** 인 경우에는 **Basis 값을 유지하며 고통분담을 하지 않습니다.**

...
순수하게 회사의 수익성을 고려하여 가치를 평가 하는 방식 입니다. 핵심 개념으로는 '자산의 가치는 현재가치의 총합이다.' 입니다. 현금의 내용을 활용하여 기업가치를 판단하는 방법으로 DCM (Discounted Cash Flow), DDM(Dividend Discount Model) 2가지가 있습니다.

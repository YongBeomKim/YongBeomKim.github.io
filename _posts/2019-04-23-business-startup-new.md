...
## 1 일반현황
### 1-1 일반현황
- 빅데이터 분석을 활용한, 똑똑한 식자재 종합관리 서비스
- 4차산업 창업분야 : 무영인터내쇼날 김용범

### 1-2 창업 아이템 개요 (요약)
- 바쁜 직장인들이 식재료를 쌓아놓는 경우가 많음
- 메뉴를 정의하면 관련 구매목록을 특정하면, 조합 가능한 메뉴목록을 자동으로 추천
- 현재 인터넷 등 에서 주목도 높은 메뉴 와 식자재 정보를 요약하여 전달

## 1 문제인식
### 1-1 창업 아이템의 개발동기
**냉장고를 부탁해** 와 같은 프로그램을 보면 실제로 사용하지도 않는 재료들을 묵히게 되고  이들의 대부분은 버리는 경우가 많습니다. 플라스틱 및 비닐류 등의 쓰레기는 사회적 제도등으로 개선이 가능하지만, 식자재는 제도적으로 관리가 어렵고 개개인들의 현명한 판단에 모두 맏겨야 되는 한계가 존재합니다

### 1-2 창업 아이템의 목적 (필요성)
'만개의 레시피' 와 '청정원 추천식단' 등의 식단준비 및 메뉴관련 서비스들은 있지만, 서비스 제공 주체가 **식자재 제조 및 유통업체** 들인 만큼 **제품군의 판매 증가** 에 집중할 뿐, **효율적인 식자재의 소비 및 관리** 는 애초 기업들의 이윤추구 목적상 실제로 도달하기도 어렵고 구현할 이유도 없습니다

그래서 활성화된 곳이 를 교류하고 있습니다. 이러한 상황에서 착안해서 이번의 새로운 창업 아이템을 구체화를 진행하게 되었습니다

## 2 실현가능성
### 2-1 창업아이템의 개발 사업화 전략
구내식당에서 영양사 분들과 교류하면서, 이분들도 필요성에 의해 1년 3만원 회비를 내고 활용하는 [영양사 도우미](http://www.kdclub.com/) 등의 커뮤니티를 활용하고 있습니다

저희 구내식당에서 12년 동안 축적된 메뉴과 식자재 정보를 바탕으로, 현재 과외활동으로 **[파이썬을 활용한 자연어 분석](https://www.ai-academy.ai/nlp1)** 강의를 통해 축적된 분석방법을 활용한다면 효과적인 식자재 관리 서비스를 구축 가능합니다 **[시범](http://erdos.gonetis.com:8000/)**

### 2-2 창업아이템의 시장분석 및 경쟁력 확보방안
식자재를 판매가 목적이 아닌, 식자재 관련 정보를 수집하고 분석하여 기업의 가치를 높여 나아가야 합니다. 즉 **식자재 쇼핑목록 서비스에 다나와 같은 오픈마켓 연계서비스** 를 구축한다면 별도의 광고없이도 운영이 가능합니다

또한 사용자들의 반응정보를 분석하여 관련 기업들에게 제공함으로써 (사용자별 선호도 패턴 및 현재 트랜드에 대한 반응 분석 Report) 부수적인 가치를 창출하고, 다양한 기업들이 정보를 활용할 수 있도록 도와드립니다.

...
### 1-2 창업 아이템 개요 (요약)
- 다양한 미디어에서 제공되는 음식관련 정보를 집약 분석하여 전달
- 구매예정 식품의 품목 및 잔여 음식물 정보를 바탕으로 조합 가능한 메뉴들을 자동으로 추천
- 영수증 OCR 텍스트 스캔 등으로 구매완료 후, 품목별 대략의 유통기한을 자동으로 관리 및 시각화
- 다양한 식품 콘텐츠 및 식자재 쇼핑몰과 연결을 통한 연계 수수료 등으로 수익의 창출

## 1 문제인식
### 1-1 창업 아이템의 개발동기
바쁜 도시생활에서 유일한 낙이 음식인 경우가 많습니다. 하지만 **냉장고를 부탁해** 에서 보는 것 처럼 할인행사, 미디어의 유혹으로 충동구매 후 냉장고 구석 구석에서 묵힌 뒤 상한 식재료를 버리는 경험을 모두가 반복적으로 하고 있습니다. 플라스틱 및 비닐 쓰레기는 제도로써 해결하고 있지만, 음식물 쓰레기 감축의 필요성은 누구나 인정 하지만, 개인의 판단 및 습관에 모두 맏기고 있습니다.

### 1-2 창업 아이템의 목적 (필요성)
'만개의 레시피' 와 '청정원 추천식단' 등의 식단준비 및 메뉴관련 서비스들이 여럿 있지만, 관리 주체가 **식자재/ 식품 제조업체**  또는 **식품 유통업체** 인 경우가 대부분 입니다. 이들은 **제품의 판매 및 유통 증가** 를 추구하는 입장에서, **효율적인 식자재 관리 및 소비절약** 은 주된 목적과 충돌 합니다.

때문에 저희 구내식당의 영양사 분들도 식자재 관리 및 메뉴정보의 공유를 위해 1년 3만원 회비를 내고 활용이 가능한 [영양사 도우미](http://www.kdclub.com/) 와 같은 다양한 사설 커뮤니티를 활용하고 있습니다.

## 2 실현가능성
### 2-1 창업아이템의 개발 사업화 전략
12년간 구내식당을 운영하면서 축적된 메뉴 와 식자재 데이터를 바탕으로 기본 틀을 구축하고, 과외로 창업자 본인이 진행한 **[파이썬을 활용한 자연어 분석](https://www.ai-academy.ai/nlp1)** 강의를 준비하면서 축적된 분석방법을 결합하여 제시한 서비스 큰틀을 자체 기술력으로도 구축이 가능합니다. **[시범사이트](http://erdos.gonetis.com:8000/)**

### 2-2 창업아이템의 시장분석 및 경쟁력 확보방안
생산 유통업체가 아닌, 소비자의 입장에서 정보를 수집 분석 제공함로써, 소비자들이 쉽고 효과적으로  활용 가능한 서비스를 제공합니다. 그리고 식자재와 메뉴 정보를 제공할 때에도, 잘 정리된 레시피 개인 블로그, 잘 정리된 유투브 채널을 함께 제공함으로써 개별 콘텐츠의 새로운 사용자 유입을 도와줍니다.

특정 유통망이 아닌, 다양한 지역별 농산물 직거래 사이트 등이 활성화 될 수 있도록 **식자재 쇼핑목록 서비스에 다나와 같은 오픈마켓 연계서비스** 의 연계수수료로 수익을 내면 별도 광고없이도 서비스 운영이 가능합니다.

또한 사용자별 활용 정보를 분석하여 관련 기업들에게 제공함으로써, 기업들이 보다 객관적인 정보를 수집 및 활용할 수 있도록 서비스를 제공합니다.

## 3 성장전략
### 3-1 자금소요 및 조달계획
- 공공단체 및 한식진흥원 등 공적펀드의 투자유치
- Gmarket, 인터파크 및 다양한 식자재 쇼핑몰과 연계 수수료 제휴
...
- 팀원 : 김명진
  - 안양시 동안구 두산벤처다임 구내식당 12년 경력 총괄 매니저 (무영인터내쇼날 2007~2019) 

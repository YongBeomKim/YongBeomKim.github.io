...
신선한 식재료를, 필요한 만큼 자주 구매하고 활용하다

기존의 코스트코 등에서 한꺼번에 많이 구매하던 습관을
필요한 만큼, 소량을, 자주, 꾸준하게 관리하면서 구매를 하자!!
오히려 자주 구매패턴이 늘어나면 서비스 이용 횟수와 관련 수익은 증가된다


#  작성목차
## 1 일반현황
### 1-1 일반현황
- 빅 데이터 분석을 활용한 음식물 관리 및 식품관련 콘텐츠 유통 플랫폼 서비스
- 4차산업 창업분야 : 무영인터내쇼날 김용범

### 1-2 창업 아이템 개요 (요약)
- 다양한 미디어의 음식관련 정보를 집약 분석하여 전달
- 구매예정 및 잔여 음식물 정보를 활용하여 조합 가능한 메뉴목록 추천
- 레시피 데이터를 활용한, 여러 식자재 정보를 자동 입력 및 삭제 관리
- 영수증의 OCR 텍스트 스캔 등 손쉬운 품목입력 및 대략적인 유통기한 관리
- 식품 콘텐츠 및 식자재 쇼핑몰과의 연계 수수료 등 다양한 수익 창출

## 1 문제인식
### 1-1 창업 아이템의 개발동기
바쁜 도시생활에서 유일한 낙이 음식인 경우가 많습니다. 하지만 **냉장고를 부탁해** 에서 보이는 것 처럼 할인행사, 미디어의 유혹 등으로 충동구매 후 냉장고 구석 구석에서 묵힌 뒤 상해버린 식재료를 버리는 경험을 상당수가 반복 합니다. 플라스틱 및 비닐 쓰레기는 제도로써 해결 하지만, 음식물 쓰레기의  감축 필요성은 누구나 인정 하지만, 개인의 판단 및 습관에 모두 맏기고 있습니다.

### 1-2 창업 아이템의 목적 (필요성)
'만개의 레시피' 와 '청정원 추천식단' 등의 식단준비 및 메뉴관련 서비스들이 여럿 있지만, 관리 주체가 **식자재 및 식품의 제조업체**  또는 **식품 유통업체** 입니다. **식재료 제품의 판매 및 유통의 증가** 를 추구하는 만큼 **식자재 관리 및 불필요한 소비절약** 은 이들 기업의 주된목적과 충돌 합니다.

이러한 이유로 제가 일하는 구내식당 영양사는, 식자재 관리 및 정보의 공유를 위해 1년 3만원 회비를 내는 [영양사 도우미](http://www.kdclub.com/) 등 사설 커뮤니티를 활용하고 있습니다.

## 2 실현가능성
### 2-1 창업아이템의 개발 사업화 전략
12년간 구내식당을 운영하면서 축적된 메뉴와 관련 재료 주문표 데이터를 활용하여 기본 틀을 구축하고, 창업자 본인이 강의를 진행하는 **[파이썬을 활용한 자연어 분석](https://www.ai-academy.ai/nlp1)** 을 준비하면서 축적된 분석 방법을 활용합니다. 이로인해 자체 기술력으로 관련된 시범 서비스를 구현할 수 있습니다. **[시범사이트](http://erdos.gonetis.com:8000/)**

### 2-2 창업아이템의 시장분석 및 경쟁력 확보방안
생산 및 유통업체가 아닌, 소비자 입장에서 쉽고 효과적으로 활용 가능한 서비스를 제공합니다. 그리고 사내 정보를 바탕으로. 잘 정리된 레시피 개인 블로그, 잘 정리된 유투브 채널의 정보를 함께 활용 및 제공 함으로써 보다 유연한 정보의 전달 및 개별 콘텐츠에게도 새로운 사용자 유입을 도와 드립니다.

축적된 사용자 활용 정보를 분석하여 관련 기업들에게 제공함으로써, 식품관련 기업들이 보다 객관적인 반응 및 분석결과를 수집 및 활용할 수 있도록 서비스를 제공합니다.

다양한 지역별 농산물 직거래 유통말 활성화를 정부에서도 추진하는 만큼 **다나와 와 같은 식자재 오픈마켓 연계서비스** 를 활용한 연계수수료로 수익을 추구하는 등 별도의 광고없이 서비스를 제공합니다.

## 3 성장전략
### 3-1 자금소요 및 조달계획
- 공공단체 및 한식진흥원 등 공적펀드의 투자유치
- 예비창업패키지 종료 후 창업도약 패키지 지원 및 투자유치
- Gmarket, 인터파크 및 aT-KAMIS 등 다양한 식자재 쇼핑몰과 연계 수수료 제휴
...
- 대표자 : 김용범 
  ...
  - 금융분석, 챗봇 개발 및 컨설팅 (인공지능 아카데미 2018~현재)
- 팀원 : 김명진
  - 안양시 동안구 두산벤처다임 구내식당 12년 경력 총괄 매니저 (무영인터내쇼날 2007~현재) 
...
식당운영에서 가장 중요한 부분이 **메뉴의 선정과 원가관리** 입니다. 

영양사를 고용하는 저희들은 전문가의 축적된 경험과 지식으로 대처를 하면서, 11년 이상 축적된 엑셀자료를 바탕으로  안정적이면서 또한 다양한 메뉴를 제공하고 있습니다. 

자체 유통망이 있거나 규모가 있는 케이터링 업체들은 저희들과 같이 축적된 데이터를 활용하여 다양한 식자재의 활용 및 원가관리가 가능합니다

하지만 5인 미만의 소규모 음식점이 86.5% 를 (농림축산식품부/2017) [중앙일보](https://news.joins.com/article/21922030) 차지하고 있고, 경영상 애로요인 1위가 (88.3%) 식재료의 상승 입니다. (한국농촌경제연구원/2019외식트랜드)

메뉴선정과 메뉴별 식재료 원가관리 시스템을 누구나 쉽게 활용할 수 있다면, 소규모 음식점 에서도 경영상 어려움에 대응이 가능하고, 일반 가정에서도 식자재를 필요한 종류와 양을 구매함으로써 불필요한 지출을 줄이고 음식물 쓰레기를 함께 줄일 수 있습니다.

## 1-2 창업아이템의 목적(필요성) - 경쟁력 측면 -
그렇다면 메뉴관리 및 식자재 정보 활용 서비스를 어떻게 구성할 것인가? 

식자재 가격이 매우 민감하게 변동하는 만큼, 예전에는 가격정보를 수집하기 어려웠었습니다. 공공데이터 개방정책으로 [농산물식품기업지원센터](https://www.kamis.or.kr/), [서울시 농수산식품 공사](http://www.garak.co.kr) 등 다양한 경로에서 제공을 하고 있어서 가격변동은 누구나 수집 가능합니다.

결국 경쟁력은 서비스 인터페이스의 구성과, 내부 데이터를 얼마나 충실하게 관리를 하느냐가 관건입니다.
...
메뉴목록과 메뉴별 식재료 정보와 가격변동을 연계한 시스템을 구성만 하면 도움이 될까?


300명 이상을 대상으로 구내식당을 영업을 하는 회사에서는 전문교육을 받은 **영양사** 분 께서 도와주고 계시고 그동안 누적된 메뉴별 작업계획서를 엑셀로 정리하여 활용을 하고 있습니다.

과거에는 메뉴와 식재료 관련의 공유가 어려웠지만, 공공데이터 개방정책과 영양사 분들의 개인 블로그의 활성화 그리고 학교별 급식메뉴 공개 등 
...
[**농촌진흥청 의 메뉴젠**](http://koreanfood.rda.go.kr/kfi/mgnmenudiaKcalnnutri/list) 과 [**청정원의 건강식단**](http://www.jungonenutri.com/user/diet/dietSearch.do?dietOrdYn=Y&pageNum=16&rdoGender=&dietCd=&gender=&age=&kcal=&rowCount=10#none) [농산물식품기업지원센터](https://www.kamis.or.kr/), [서울시 농수산식품 공사](http://www.garak.co.kr)

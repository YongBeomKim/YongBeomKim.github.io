...
제가 소속된 구내식당의 영양사 분들도, 식자재 관리 및 메뉴정보의 공유를 위해 1년 3만원 회비를 내는 [영양사 도우미](http://www.kdclub.com/) 등의 다양한 사설 커뮤니티를 활용하고 있습니다.

## 2 실현가능성
### 2-1 창업아이템의 개발 사업화 전략
12년간 구내식당을 운영하면서 축적된 메뉴와 관련 재료 주문표 데이터를 활용하여 기본 틀을 구축하고, 창업자 본인이 진행한 **[파이썬을 활용한 자연어 분석](https://www.ai-academy.ai/nlp1)** 강의를 준비하면서 축적된 분석 방법을 결합하여 Demo 서비스 및 기술 개선은 자체 기술력으로도 구축 가능합니다. **[시범사이트](http://erdos.gonetis.com:8000/)**

### 2-2 창업아이템의 시장분석 및 경쟁력 확보방안
생산 및 유통업체가 아닌, 소비자 입장에서 쉽고 효과적으로  활용 가능한 서비스를 제공합니다. 그리고 식자재와 메뉴 정보를 제공할 때에도, 잘 정리된 레시피 개인 블로그, 잘 정리된 유투브 채널을 함께 제공함으로써 개별 콘텐츠의 새로운 사용자 유입을 도와 드립니다.

사용자별 활용 정보를 분석하여 관련 기업들에게 제공함으로써, 기업들이 보다 객관적인 정보를 수집 및 활용할 수 있도록 서비스를 제공합니다.

그리고 다양한 지역별 농산물 직거래 사이트 등이 활성화 될 수 있도록 **다나와 와 같은 식자재 오픈마켓 연계서비스** 를 활용한 연계수수료로 등을 통해서 별도의 광고없이도 서비스를 운영합니다.
